module PipelinedProc(
    ...
    //startPC hardcoded value
    localparam startPC = 32'h80000000;
    ...
    //Stage 2 Logic
    assign ID_rs2 = ID_instruction[24:20]; //need values for load-use hazard detection
    assign ID_rs1 = ID_instruction[19:15];//switched to ID_instruction from IF since BRAM two cycle IF stage
